...
def bishop_move_enable(bishopfield, destField, chessBoardStatus):
    ...
    if actuallSquareColour == destFieldColour and bishopColour != figureColourOnDestField: #check if destination square is the same colour and figure on dest field is different colour or empty
